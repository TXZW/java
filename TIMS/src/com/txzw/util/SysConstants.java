...
public class SysConstants {
	...
	public static final String DB_LISTENERPORT = "DB_PROT";
	public static final String SYS_HOSTNAME = "HOST";
	public static final String DB_HOSTNAME = "DB_HOST";
	public static final String MYSQL_DRIVER = "MYSQL_DRIVER";
	public static final String MYSQL_URI = "MYSQL_URI";
